                ...
                <div class="card-body">
                    ...
                    <div class="form-group row border">
                        <div class="table-responsive col-md-12">
                            <table class="table table-bordered tabl-striped table-sm">
                                <thead>
                                    <tr>
                                        <th>Opciones</th>
                                        <th>Articulo</th>
                    ...
                    <div class="form-group row">
                        <div class="col-md-12">
                            ...
                            <button type="button" class="btn btn-primary" @click="regstrarIngreso()">Registrar Compra</button>
                        </div>
                    </div>
                </div>
            </template>
        ...
        methods: {
            ...
            encuentra(id){
                ...
                for (var i = 0; i < this.arrayDetalle.length; i++) {
                    if(id == this.arrayDetalle[i].idarticulo){
                        sw = true;
                    }
                }
                return sw;
